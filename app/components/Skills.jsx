...
//   return (
//     <section id="skills" className="w-11/12 max-w-6xl mx-auto py-20 ml-6">
//       {/* Section Title */}
//       <motion.h2
//         className="text-5xl font-bold text-center text-gray-900 mb-14 tracking-wide"
...
//         {/* 🎯 Left Side - Skills */}
//         <motion.div
//           className="bg-white p-2 rounded-xl shadow-lg border border-gray-200"
//           initial={{ opacity: 0, x: -50 }}
//           whileInView={{ opacity: 1, x: 0 }}
//           transition={{ duration: 1 }}
//           viewport={{ once: true }} // Ensures the animation only happens once
//         >
//           <h3 className="text-4xl font-semibold text-blue-700 mb-2">Skills</h3>
...
//                   <p className="text-lg font-small text-gray-900">{skill.skill}</p>
//                   <p className="text-sm font-small text-gray-700">{skill.level}%</p>
//                 </div>

//                 {/* Progress Bar */}
//                 <div className="relative w-full h-2 bg-gray-200 rounded-full">
//                   <motion.div
//                     className="absolute h-full bg-gradient-to-r from-blue-500 to-blue-700 rounded-full shadow-md"
//                     initial={{ width: 0 }}
...
//           viewport={{ once: true }} // Ensures the animation only happens once
//         >
//           <h3 className="text-4xl font-semibold text-blue-700 mb-4">Experience</h3>

//           <div className="space-y-6">
//             {experienceData.map((exp, index) => (
//               <motion.div
//                 key={index}
//                 className="p-5 bg-gray-50 border-l-4 border-blue-600 shadow-sm rounded-lg hover:shadow-md transition-shadow duration-300"
//                 initial={{ opacity: 0, x: 20 }}
//                 whileInView={{ opacity: 1, x: 0 }}
//                 transition={{ duration: 0.8, delay: index * 0.2 }}
//                 viewport={{ once: true }} // Ensures the animation only happens once
//               >
//                 <h4 className="text-3xl font-bold text-gray-900">{exp.role} </h4>
//                 <p className="text-2xl font-semibold text-gray-600">
//                   {exp.company} • {exp.year}
//                 </p>
//                 <p className="text-xm text-gray-600">{exp.location}</p>
