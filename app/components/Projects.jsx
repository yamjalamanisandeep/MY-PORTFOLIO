...
// const Projects = () => {
//   return (
//     <div id="projects" className={`w-11/12 max-w-6xl mx-auto py-16 scroll-mt-16 ${outfit.variable} font-sans`}>
//       {/* Section Title */}
//       <motion.h2
...
//           <motion.div
//             key={index}
//             className="bg-gradient-to-br from-blue-50 to-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 border border-gray-100"
