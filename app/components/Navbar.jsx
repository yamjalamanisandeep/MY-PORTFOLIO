...
//         setActiveSection(section); // Immediately set the active section
...
//                 <a 
//                     href="#home" 
//                     className="text-2xl font-bold cursor-pointer hover:text-blue-600 dark:hover:text-yellow-400 transition-colors duration-300"
//                     onClick={() => handleNavLinkClick('home')} // Add click handler for Home link
//                 >
//                     MANI SANDEEP
//                 </a>
...
//                         <li key={section}>
//                             <a 
//                                 className={`font-Ovo hover:text-blue-600 dark:hover:text-yellow-400 transition-colors duration-300 ${activeSection === section ? 'border-b-2 border-blue-600 dark:border-yellow-400 font-bold' : ''}`} 
//                                 href={`#${section}`}
//                                 onClick={() => handleNavLinkClick(section)} // Add click handler
//                             >
//                                 {section.charAt(0).toUpperCase() + section.slice(1)}
//                             </a>
//                         </li>
...
//                     <a 
//                         href="#contact" 
//                         className="hidden lg:flex items-center gap-3 px-10 py-2.5 border border-gray-500 dark:border-yellow-500 rounded-full ml-4 font-Ovo hover:bg-blue-600 dark:hover:bg-yellow-500 hover:text-white dark:hover:text-gray-900 hover:border-blue-600 dark:hover:border-yellow-500 transition-colors duration-300"
//                     >
//                         Contact
//                         <Image
//                             src={assets.arrow_icon || '/images/fallback-arrow-icon.png'}
...
//             {/* Profile Section */}
//             {/* <section id="home" className="md:hidden flex flex-col items-center justify-center w-full min-h-screen pt-0">
